...
2. reduce duplication of effort by scientists and developers in handling non-compliance. For example,
   ...
   * The HAPI metadata generation code addresses many anomolies. See the files in the [attrib directory](https://github.com/rweigel/cdawmeta/tree/main/cdawmeta/attrib) and [hapi.py](https://github.com/rweigel/cdawmeta/blob/main/cdawmeta/_generate/hapi.py). [Logs](http://mag.gmu.edu/git-data/cdawmeta/data/hapi/) of issues encountered that affected HAPI metadata generation encountered is generated by this code. Thes issues are tracked in the [cdawmeta issue tracker](https://github.com/rweigel/cdawmeta/issues) and we add information conveyed to us via email or on telecons.
