Each key in `units-CDFUNITS_to_SPASEUnit-map.json` is a unique CDF master unit found across all variables. The value is an object with keys of associated SPASE Units and values of counts.
