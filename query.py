...
def query(name):
  ...
  if name == 'units':
    ...
    for dsid in meta.keys():
      ...
      spase = meta[dsid]['spase']['data']
      hapi = meta[dsid]['hapi']['data']
      ...
      for parameter in parameters:
        ...
        if Parameters is not None and name in Parameters:
          if 'Units' in Parameters[name]:
            ...
            logger.error("    SPASE: \033[91mx No Units attribute\033[0m")
        else:
          logger.error("    SPASE: \033[91mx Parameter not found\033[0m")
