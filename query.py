...
if name == 'f2c_specifier':
  ...
  lines = "# CDFDataType, GivenSpecifier, InferredFortranSpecifier\n"
...
if name == 'FORMAT':
  ...
  body_file = "data/table/cdaweb.table.variable.body.json"
  header_file = "data/table/cdaweb.table.variable.head.json"
  import json
