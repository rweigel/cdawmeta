...
def spase(id=None, update=True, diffs=None, max_workers=None, no_orig_data=False):

  import cdawmeta
  datasets = cdawmeta.metadata(id=id, update=False, no_spase=False, embed_data=True)
